...
Las estadísticas que se generaron sobre la curva y la integral hipsométrica se obtuvieron 60 resultados para los cursos de agua pertenecientes a la cuenca de orden 2. El valor mínimo generado para la integral hipsométrica fue 0.08 en el curso 43. En tanto, el valor máximo para la integra fue de 0.48 en el curso 45 (ver tabla \ref{ihco2}). Y los cursos más curvos fuero 37, 18 y 15 (ver figuras \ref{hypsob2} y \ref{hypb2}).
...
Table: \label{parh} Estadisticas de parámetros hidrgográficos según el orden de red
...
Table: \label{razones} Razones de los parámetros hidrográficos según su orden de red
