...
De acuerdo con el mapa de @Mmar2015cuenca, la cabecera del rio Guayubín se ubica en la vertiente noroeste de el Cerro La Pelada, mientras que sus aguas se vierten en el río Yaque del Norte, localidad Guayubín. 
...
Se usó el addon `r.water.outlet` (@wateroutlet) para la extraccion de la cuenca a traves de un mapa de direccion de drenajes (creado con el addon r.watershed), y de coordenadas de desembocadura de la cuenca (obtenidas con `Mapview`). Asi tambien se uso el addon `r.to.vect` (@tovect), para convertir un raster en vectorial.
